...
function ws_display_list($window_name, $form='') {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => Displaying hosts list page: {$page}", 1);
    ...
    if ($form['domain'] and !$form['hostname']) {
        ...
        printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "FIXME: => Does \$form['domain'] work correctly in list_hosts.inc.php?", 2);

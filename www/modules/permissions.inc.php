...
function add_permission($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . 'DEBUG => add_permission('.$options.') called', 3);
...
EOM
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => ID for new permission record: $id", 3);

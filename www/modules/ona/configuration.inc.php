...
function config_display($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . 'DEBUG => config_display('.$options.') called', 3);
...
function config_chksum($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . 'DEBUG => config_chksum('.$options.') called', 3);
...
function config_add($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . 'DEBUG => config_add('.$options.') called', 7);
...
EOM
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => ID for new config_record: $id", 3);
...
function config_diff($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . 'DEBUG => config_diff('.$options.') called', 3);

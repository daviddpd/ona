...
function block_add($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => block_add({$options}) called", 3);
...
EOM
    ...
    if ($status or $rows) {
        ...
        printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => The block {$options['name']} already exists!",3);
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => ID for new block: $id", 3);
...
function block_del($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => block_del({$options}) called", 3);
...
EOM
    ...
    if (is_numeric($options['block'])) {
        ...
        if (!$block['id']) {
            ...
            printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => Unable to find block using the ID {$options['block']}!",3);
        ...
        if (!$block['id']) {
            ...
            printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => Unable to find block using the name {$options['block']}!",3);
            return(array(2, $self['error'] . "\n"));
        }
    }
...
function block_modify($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => block_modify({$options}) called", 3);
...
EOM
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => Found block: {$block['name']}", 3);
    ...
    if ($options['set_name']) {
        ...
        if ($status or $rows) {
            printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => The block {$options['set_name']} already exists!",3);
...
function block_display($options="") {
    ...
    printmsg( pstr(__FILE__,__LINE__,__FUNCTION__) . "DEBUG => block_display({$options}) called", 3);
